...
class AliPay extends Controller
{
    ...
    {
        $data['subject'] = $request->post('subject');              //商品订单名称
        $data['out_trade_no'] = $request->post('out_trade_no').mt_rand(1111,9999);    //商户网站唯一订单号
        $data['total_fee'] = $request->post('total_fee');          //交易金额
